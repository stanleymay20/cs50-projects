...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        # If person has no parents listed
        if mother is None and father is None:
            gene_prob = PROBS["gene"][gene_count]
        else:
            # Compute passing probabilities
            ...
            # Compute child gene probability
            if gene_count == 2:
        ...
        # Trait probability given gene count
...
def update(probabilities, one_gene, two_genes, have_trait, p):
    ...
    for person in probabilities:
        ...
        # Update the relevant gene and trait probability
